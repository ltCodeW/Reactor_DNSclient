...
int dnsProcess(FILE *, int, struct sockaddr *);
...
int main(int C, char *argv[])
{
    ...
    ret = dnsProcess(stdin, sd, (struct sockaddr *)&serveraddress);
    if (0 > ret)
    {
...
int dnsProcess(FILE *fp, /*Here to be used as stdin as argument*/
               int sockfd,
               struct sockaddr *to) /*Connection Socket */
{

    char domain_name[BUFSIZE], recvbuf[BUFSIZE], servername[MAXSERVERNAME];
    char *cptr;
